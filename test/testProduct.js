...
describe('testing /api/product and products', function() {
  it('POST teussernaturell should return teussernaturell', function(done) {
    chai.request(app)
      .post('/api/product')
  ...
  it('POST heiligenquelleclassic should return heiligenquelleclassic', function(done) {
    chai.request(app)
      .post('/api/product')
      .set('x-access-token', token)
  ...
  it('POST vittelwater should return vittelwater', function(done) {
    chai.request(app)
      .post('/api/product')
      .set('x-access-token', token)
      .send(vittelwater)
  ...
  it('POST volvic should return volvic_50cl', function(done) {
    chai.request(app)
      .post('/api/product')
      .set('x-access-token', token)
      .send(volvic_50cl)
